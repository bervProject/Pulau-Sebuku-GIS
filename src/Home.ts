...
export default class Home extends Vue {
  ...
  protected url: string = 'http://{s}.tile.osm.org/{z}/{x}/{y}.png'
  protected zoom: number = 11.1
  protected center: number[] = [-3.5, 116.36667]
  protected coastline: any = null
  protected peak: any = null
  protected lahanKritis: any = null
  protected isPeak: boolean = true
  protected isCoastline: boolean = true
  protected isLahanKritis: boolean = true
